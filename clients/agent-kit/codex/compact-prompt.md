# Compaction prompt addition (engram) — Codex
...
1. Call the engram `checkpoint` tool with the content of this compacted
   summary (agentId from ENGRAM_AGENT_ID). This persists pre-compaction work.
