...
| | |
|---|---|
| Status | **ACCEPTED v5.1** — reviewed by Tomas and merged to main as 3429000 (PR #10, 2026-09-03). Implementation proceeds per §7, one gated PR per step: **H1 merged** as e678479 (PR #11, codex LGTM ee5d9f89; `heads.ts`); **H2 in progress** (branch `feat/eng4-h2-version-foundation`; `src/unified-server/eng4/versions.ts`, `tests/contract-eng4-h2-version-foundation.test.ts`). Prior draft history: v5.1 was codex-hythe's takeover revision incorporating review 12281537 while claude-hythe was temporarily disabled. §2.10 is **RULED**: the H-series is `resultVersion: 3` (Tomas, 2026-09-03). |
